...
class AudiooutServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def Play(self, stream: 'grpclib.server.Stream[audioout_pb2.PlayRequest, audioout_pb2.PlayResponse]') -> None:
        pass

    @abc.abstractmethod
    async def Stop(self, stream: 'grpclib.server.Stream[audioout_pb2.StopRequest, audioout_pb2.StopResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            '/viamlabs.service.audioout.v1.AudiooutService/Play': grpclib.const.Handler(
                ...
                audioout_pb2.PlayRequest,
                audioout_pb2.PlayResponse,
            ),
            '/viamlabs.service.audioout.v1.AudiooutService/Stop': grpclib.const.Handler(
                self.Stop,
                grpclib.const.Cardinality.UNARY_UNARY,
                audioout_pb2.StopRequest,
                audioout_pb2.StopResponse,
            ),
        }
